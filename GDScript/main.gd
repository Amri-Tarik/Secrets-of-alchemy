...
var earth = { "particle" : preload("res://scenes/particles/earth.tscn"),"burstscale" : Vector2(1,1), "aoescale" : Vector2(1.5,1.5),"aurascale" : Vector2(1.5,1.5), "centralburst" : Vector2(0,0),"impulseburst" : [0,7,-10,0],"centralaoe" : Vector2(0,5),"impulseaoe" : [0,0,0,0], "follow_mouse" : 1, "aoe_fill" : 1, "layer_bit" : 0}
